...
const handleGenerateCode = async () => {
  try {
    const response = await fetch(`http://localhost:3002/api/templates/133`);
...
useEffect(() => {
  fetchAndUpdateDisplayContent(134); // 初始渲染時加載 templateId 為 5 的模板
        ...
        <div class="col-md-12">
          <div class="cardt">
            <div class="cardt-info">
              <p class="titlet">SQL Connection</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card-header">
              <div class="navigation">
                <ul>
                  <li
                    class="list active"
                    onClick={() =>fetchAndUpdateDisplayContent(134)}
                  >
                    <span class="icon">
                      <svg
                  ...
                  <li
                    class="list"
                    onClick={() =>fetchAndUpdateDisplayContent(135)}
                  >
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"

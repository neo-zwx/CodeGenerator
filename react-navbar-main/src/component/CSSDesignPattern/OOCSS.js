...
const handleGenerateCode = async () => {
  try {
    const response = await fetch(`http://localhost:3002/api/templates/141`);
...
useEffect(() => {
  fetchAndUpdateDisplayContent(140); // 初始渲染時加載 templateId 為 5 的模板
            ...
            <div class="card-header">
              <div class="navigation">
                <ul>
                  <li
                    class="list active"
                    onClick={() =>fetchAndUpdateDisplayContent(140)}
                  >
                    <span class="icon">
                    <svg
                  ...
                  <li
                    class="list"
                    onClick={() =>fetchAndUpdateDisplayContent(142)}
                  >
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <li
                    class="list"
                    onClick={() =>fetchAndUpdateDisplayContent(143)}
                  >
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"

...
const initialFormData = {
  ...
  buttoniconsmall: "buttoniconsmall",
};
...
const BEM = () => {
  ...
  const handleGenerateCode = async () => {
    try {
      const response = await fetch(`http://localhost:3002/api/templates/145`);
  ...
  useEffect(() => {
    fetchAndUpdateDisplayContent(144); // 初始渲染時加載 templateId 為 5 的模板
            ...
            <div class="card-header">
              <div class="navigation">
                <ul>
                  <li
                    class="list active"
                    onClick={() => fetchAndUpdateDisplayContent(144)}
                  >
                    <span class="icon">
                      <svg
                  ...
                  <li
                    class="list"
                    onClick={() => fetchAndUpdateDisplayContent(146)}
                  >
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <li
                    class="list"
                    onClick={() => fetchAndUpdateDisplayContent(147)}
                  >
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"

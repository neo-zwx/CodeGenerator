...
const DropdownMenu = () => {
  ...
  const handleGenerateCode = async () => {
    try {
      const response = await fetch(`http://localhost:3002/api/templates/152`);
  ...
  useEffect(() => {
    fetchAndUpdateDisplayContent(152); // 
            ...
            <div class="card-header">
              <div class="navigation">
                <ul>
                  <li
                    class="list active"
                    onClick={() => fetchAndUpdateDisplayContent(152)}
                  >
                    <span class="icon">
                      <svg
                  ...
                  <li
                    class="list"
                    onClick={() => fetchAndUpdateDisplayContent(153)}
                  >
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <li
                    class="list"
                    onClick={() => fetchAndUpdateDisplayContent(154)}
                  >
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"

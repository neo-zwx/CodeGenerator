...
const ReactNavbar = () => {
  ...
  const handleGenerateCode = async () => {
    try {
      const response = await fetch(`http://localhost:3002/api/templates/158`);
  ...
  useEffect(() => {
    fetchAndUpdateDisplayContent(158); // 初始渲染時加載 
            ...
            <div class="card-header">
              <div class="navigation">
                <ul>
                  <li
                    class="list active"
                    onClick={() => fetchAndUpdateDisplayContent(158)}
                  >
                    <span class="icon">
                      <svg
                  ...
                  <li
                    class="list"
                    onClick={() => fetchAndUpdateDisplayContent(159)}
                  >
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <li
                    class="list"
                    onClick={() => fetchAndUpdateDisplayContent(160)}
                  >
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"

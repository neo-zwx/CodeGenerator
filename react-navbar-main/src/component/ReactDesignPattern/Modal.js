...
const initialFormData = {
    ...
    content: "This is a modal window. You can do the following things with it:",
    Read: "Read:",
    Readcontent: "modal dialogs will probably tell you something important so don't forget to read what it says.",
    Look: "Look:",
    Lookcontent: "a modal isn't just a big old rectangle; look at how well it can be styled and how it behaves.",
};
...
const Modal = () => {
  ...
  const handleGenerateCode = async () => {
    try {
      const response = await fetch(`http://localhost:3002/api/templates/155`);
  ...
  const fetchAndUpdateDisplayContent = async (templateId) => {
    try {
      const response = await fetch(
        `http://localhost:3002/api/templates/${templateId}`
      );
      const data = await response.json();
  ...
  useEffect(() => {
    fetchAndUpdateDisplayContent(155); // 初始渲染時加載 
            ...
            <div class="card-header">
              <div class="navigation">
                <ul>
                  <li
                    class="list active"
                    onClick={() => fetchAndUpdateDisplayContent(155)}
                  >
                    <span class="icon">
                      <svg
                  ...
                  <li
                    class="list"
                    onClick={() => fetchAndUpdateDisplayContent(156)}
                  >
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <li
                    class="list"
                    onClick={() => fetchAndUpdateDisplayContent(157)}
                  >
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"

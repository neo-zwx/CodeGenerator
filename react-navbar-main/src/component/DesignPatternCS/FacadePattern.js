...
import { EXFacadePattern, CDFacadePattern, HTFacadePattern } from "../../window/CSWindow/FacadeModal.js";
import "../../css/pre.css";
...
const initialFormData = {
  ...
  SubsystemAOpe: "SubsystemAOperationA",
  SubsystemB: "SubsystemB",
  OperationB: "OperationB",
  SubsystemBOpe: "SubsystemBOperationB",
  SubsystemC: "SubsystemC",
  OperationC: "OperationC",
  SubsystemCOpe: "SubsystemCOperationC",
  subsystemA: "subsystemA",
  subsystemB: "subsystemB",
  subsystemC: "subsystemC",
  Operation1: "Operation1",
  FacadeOperation1: "Facade Operation1",
  Operation2:"Operation2",
  FacadeOperation2: "Facade Operation2",
};
...
const FacadePattern = () => {
  ...
  useEffect(() => {
    fetchAndUpdateDisplayContent(29); // 初始渲染時加載 templateId 為 5 的模板
  ...
  const handleGenerateCode = async () => {
    try {
      const response = await fetch(`http://localhost:3002/api/templates/29`);
      const data = await response.json();
        ...
        <div class="col-md-12">
          <div class="cardt">
            <div class="cardt-info">
              <p class="titlet">Facade Pattern</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card-header">
              <div class="navigation">
                <ul>
                  <li
                    class="list active"
                    onClick={() =>fetchAndUpdateDisplayContent(29)} >
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"
                  ...
                  <li
                    class="list"
                    onClick={() =>fetchAndUpdateDisplayContent(30)} > 
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"

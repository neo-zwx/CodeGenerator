...
import { EXDecoratorPattern, CDDecoratorPattern, HTDecoratorPattern } from "../../window/CSWindow/DecoratorModal.js";
import "../../css/pre.css";
...
const initialFormData = {
  ...
  AddedBehaviorA: "AddedBehaviorA",
  ConcreteDecoratorAAdd: "ConcreteDecoratorAAdd",
  ConcreteDecoratorB: "ConcreteDecoratorB",
  AddedBehaviorB: "AddedBehaviorB",
  ConcreteDecoratorBAdd: "ConcreteDecoratorBAdd",
};
...
const DecoratorPattern = () => {
  ...
  useEffect(() => {
    fetchAndUpdateDisplayContent(26); // 初始渲染時加載 templateId 為 5 的模板
  ...
  const handleGenerateCode = async () => {
    try {
      const response = await fetch(`http://localhost:3002/api/templates/26`);
      const data = await response.json();
            ...
            <div class="card-header">
              <div class="navigation">
                <ul>
                  <li
                    class="list active"
                    onClick={() =>fetchAndUpdateDisplayContent(26)} >
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"
                  ...
                  <li
                    class="list"
                    onClick={() =>fetchAndUpdateDisplayContent(27)} > 
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"

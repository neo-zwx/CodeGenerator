...
import { EXMementoPattern, CDMementoPattern, HTMementoPattern } from "../../window/CSWindow/MementoModal.js";
import "../../css/pre.css";
...
const MementoPattern = () => {
  ...
  useEffect(() => {
    fetchAndUpdateDisplayContent(56); // 初始渲染時加載 templateId 為 5 的模板
  ...
  const handleGenerateCode = async () => {
    try {
      const response = await fetch(`http://localhost:3002/api/templates/56`);
      const data = await response.json();
            ...
            <div class="card-header">
              <div class="navigation">
                <ul>
                  <li
                    class="list active"
                    onClick={() =>fetchAndUpdateDisplayContent(56)} >
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"
                  ...
                  <li
                    class="list"
                    onClick={() =>fetchAndUpdateDisplayContent(57)} > 
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"

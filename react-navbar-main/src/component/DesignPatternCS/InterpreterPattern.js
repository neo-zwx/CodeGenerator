...
import { EXInterpreterPattern, CDInterpreterPattern, HTInterpreterPattern } from "../../window/CSWindow/InterpreterModal.js";
import "../../css/pre.css";
...
const InterpreterPattern = () => {
  ...
  useEffect(() => {
    fetchAndUpdateDisplayContent(65); // 初始渲染時加載 templateId 為 5 的模板
  ...
  const handleGenerateCode = async () => {
    try {
      const response = await fetch(`http://localhost:3002/api/templates/65`);
      const data = await response.json();
        ...
        <div class="col-md-12">
          <div class="cardt">
            <div class="cardt-info">
              <p class="titlet">Interpreter Pattern</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card-header">
              <div class="navigation">
                <ul>
                  <li
                    class="list active"
                    onClick={() =>fetchAndUpdateDisplayContent(65)} >
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"
                  ...
                  <li
                    class="list"
                    onClick={() =>fetchAndUpdateDisplayContent(66)} > 
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"

...
import { CDVisitorPattern,EXVisitorPattern,HTVisitorPattern} from "../../window/CSWindow/VisitorModal.js";
import "../../css/pre.css";
...
const initialFormData = {
  ...
  OperationAOpe: "OperationAOpe",
  OperationB: "OperationB",
  OperationBOpe: "OperationBOpe",
  unVisitorOpe: "unVisitorOpe",
};
...
const VisitorPattern = () => {
  ...
  useEffect(() => {
    fetchAndUpdateDisplayContent(62); // 初始渲染時加載 templateId 為 5 的模板
  ...
  const handleGenerateCode = async () => {
    try {
      const response = await fetch(`http://localhost:3002/api/templates/62`);
      const data = await response.json();
            ...
            <div class="card-header">
              <div class="navigation">
                <ul>
                  <li
                    class="list active"
                    onClick={() =>fetchAndUpdateDisplayContent(62)} >
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"
                  ...
                  <li
                    class="list"
                    onClick={() =>fetchAndUpdateDisplayContent(63)} > 
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"

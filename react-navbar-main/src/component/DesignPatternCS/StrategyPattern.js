...
import { EXStrategyPattern, CDStrategyPattern, HTStrategyPattern } from "../../window/CSWindow/StrategyModal.js";
import "../../css/pre.css";
import TableRow from "../TableRow.js";
//初始化表單數據
const initialFormData = {
  ConcreteStrategyA: "ConcreteStrategyA",
  ConStrategyAAlg: "ConStrategyAAlg",
  ConcreteStrategyB: "ConcreteStrategyB",
  ConStrategyBAlg: "ConStrategyBAlg",
};
...
const StrategyPattern = () => {
  ...
  useEffect(() => {
    fetchAndUpdateDisplayContent(59); // 初始渲染時加載 templateId 為 5 的模板
  ...
  const handleGenerateCode = async () => {
    try {
      const response = await fetch(`http://localhost:3002/api/templates/59`);
      const data = await response.json();
            ...
            <div class="card-header">
              <div class="navigation">
                <ul>
                  <li
                    class="list active"
                    onClick={() =>fetchAndUpdateDisplayContent(59)} >
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"
                  ...
                  <li
                    class="list"
                    onClick={() =>fetchAndUpdateDisplayContent(60)} > 
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"

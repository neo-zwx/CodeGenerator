...
import { EXBridgePattern, CDBridgePattern, HTBridgePattern } from "../../window/CSWindow/BridgeModal.js";
import "../../css/pre.css";
import TableRow from "../TableRow.js";
//初始化表單數據
const initialFormData = {
  OperationImpl: "OperationImplement()",
  ConcreteImplementorA: "ConcreteImplementorA",
  ConcreteImplementorAOpe: "Concrete ImplementorA Operation",
  ConcreteImplementorB :"ConcreteImplementorB",
  ConcreteImplementorBOpe: "Concrete ImplementorB Operation",
  Operation: "Operation()",
  RefinedAbstractionOpe: "Refined Abstraction Operation",
};
...
const BridgePattern = () => {
  ...
  useEffect(() => {
    fetchAndUpdateDisplayContent(20); // 初始渲染時加載 templateId 為 5 的模板
  ...
  const handleGenerateCode = async () => {
    try {
      const response = await fetch(`http://localhost:3002/api/templates/20`);
      const data = await response.json();
        ...
        <div class="col-md-12">
          <div class="cardt">
            <div class="cardt-info">
              <p class="titlet">Bridge Pattern</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card-header">
              <div class="navigation">
                <ul>
                  <li
                    class="list active"
                    onClick={() =>fetchAndUpdateDisplayContent(20)} >
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"
                  ...
                  <li
                    class="list"
                    onClick={() =>fetchAndUpdateDisplayContent(21)} > 
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"

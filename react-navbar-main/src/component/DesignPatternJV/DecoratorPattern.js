...
import { EXDecoratorPattern, CDDecoratorPattern, HTDecoratorPattern } from "../../window/JavaWindow/DecoratorModaljv.js";
import "../../css/pre.css";
import TableRow from "../TableRow.js";
//初始化表單數據
const initialFormData = {
  operation: "operation",
  ConcreteComponentOpe: "ConcreteComponentOpe",
  addedBehavior: "addedBehavior",
  ConcreteDecoratorA: "ConcreteDecoratorA",
  ConcreteDecoratorABehavior: "ConcreteDecoratorABehavior",
  ConcreteDecoratorB: "ConcreteDecoratorB",
  ConcreteDecoratorBBehavior: "ConcreteDecoratorBBehavior",
};
...
const handleGenerateCode = async () => {
  try {
    const response = await fetch(`http://localhost:3002/api/templates/92`);
...
useEffect(() => {
  fetchAndUpdateDisplayContent(92); // 初始渲染時加載 templateId 為 5 的模板
        ...
        <div class="col-md-12">
          <div class="cardt">
            <div class="cardt-info">
              <p class="titlet">Decorator Pattern</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card-header">
              <div class="navigation">
                <ul>
                  <li
                    class="list active"
                    onClick={() =>fetchAndUpdateDisplayContent(92)} >
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"
                  ...
                  <li
                    class="list"
                    onClick={() =>fetchAndUpdateDisplayContent(93)} > 
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"

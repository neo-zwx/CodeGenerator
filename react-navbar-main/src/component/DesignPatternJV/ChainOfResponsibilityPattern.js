...
import { CDChainOfResponsibilityPattern,EXChainOfResponsibilityPattern,HTChainOfResponsibilityPattern } from "../../window/JavaWindow/ChainOfResponsibilityModaljv.js";
import "../../css/pre.css";
...
const ChainOfResponsibiltyPattern = () => {
...
const handleGenerateCode = async () => {
  try {
    const response = await fetch(`http://localhost:3002/api/templates/113`);
...
useEffect(() => {
  fetchAndUpdateDisplayContent(113); // 初始渲染時加載 templateId 為 5 的模板
        ...
        <div class="col-md-12">
          <div class="cardt">
            <div class="cardt-info">
              <p class="titlet">Chain Of Responsibility Pattern</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card-header">
              <div class="navigation">
                <ul>
                  <li
                    class="list active"
                    onClick={() =>fetchAndUpdateDisplayContent(113)} >
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"
                  ...
                  <li
                    class="list"
                    onClick={() =>fetchAndUpdateDisplayContent(114)} > 
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"
...
export default ChainOfResponsibiltyPattern;

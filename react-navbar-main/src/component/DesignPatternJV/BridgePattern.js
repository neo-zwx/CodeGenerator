...
import { EXBridgePattern, CDBridgePattern, HTBridgePattern } from "../../window/JavaWindow/BridgeModaljv.js";
import "../../css/pre.css";
...
const initialFormData = {
  ...
  ConcreteImplementorAOperation: "ConcreteImplementorA Operation",
  ConcreteImplementorB: "ConcreteImplementorB",
  ConcreteImplementorBOperation: "ConcreteImplementorB Operation",
  Operation : "Operation",
  RefinedAbstractionoperation: "RefinedAbstraction operation",
};
...
const handleGenerateCode = async () => {
  try {
    const response = await fetch(`http://localhost:3002/api/templates/86`);
...
useEffect(() => {
  fetchAndUpdateDisplayContent(86); // 初始渲染時加載 templateId 為 5 的模板
            ...
            <div class="card-header">
              <div class="navigation">
                <ul>
                  <li
                    class="list active"
                    onClick={() =>fetchAndUpdateDisplayContent(86)} >
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"
                  ...
                  <li
                    class="list"
                    onClick={() =>fetchAndUpdateDisplayContent(87)} > 
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"

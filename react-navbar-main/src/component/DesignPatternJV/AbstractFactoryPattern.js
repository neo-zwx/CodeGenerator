...
import { EXAbstractFactoryPattern, CDAbstractFactoryPattern, HTAbstractFactoryPattern } from "../../window/JavaWindow/AbstractFactoryModaljv.js";
import "../../css/pre.css";
...
const initialFormData = {
  ...
  ConcreteProductA1Ope: "ConcreteProductA1Ope",
  ConcreteProductB1: "ConcreteProductB1",
  ConcreteProductB1Ope: "ConcreteProductB1Ope",
  ConcreteProductA2: "ConcreteProductA2",
  ConcreteProductA2Ope: "ConcreteProductA2Ope",
...
const handleGenerateCode = async () => {
  try {
    const response = await fetch(`http://localhost:3002/api/templates/71`);
...
useEffect(() => {
  fetchAndUpdateDisplayContent(71); // 初始渲染時加載 templateId 為 5 的模板
            ...
            <div class="card-header">
              <div class="navigation">
                <ul>
                  <li
                    class="list active"
                    onClick={() =>fetchAndUpdateDisplayContent(71)} >
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"
                  ...
                  <li
                    class="list"
                    onClick={() =>fetchAndUpdateDisplayContent(72)} > 
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"

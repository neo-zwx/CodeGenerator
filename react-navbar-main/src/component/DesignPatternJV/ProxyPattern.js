...
import { EXProxyPattern, CDProxyPattern, HTProxyPattern } from "../../window/JavaWindow/ProxyModaljv.js";
import "../../css/pre.css";
import TableRow from "../TableRow.js";
//初始化表單數據
const initialFormData = {
  request: "request",
  RealSubjectRequest: "RealSubjectRequest",
  preRequest: "preRequest",
  ProxyName: "ProxyName",
  postRequest: "postRequest",
  PreRequestOpe: "PreRequestOpe",
  PostRequestOpe: "PostRequestOpe",
};
...
const handleGenerateCode = async () => {
  try {
    const response = await fetch(`http://localhost:3002/api/templates/98`);
...
useEffect(() => {
  fetchAndUpdateDisplayContent(98); // 初始渲染時加載 templateId 為 5 的模板
        ...
        <div class="col-md-12">
          <div class="cardt">
            <div class="cardt-info">
              <p class="titlet">Proxy Pattern</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card-header">
              <div class="navigation">
                <ul>
                  <li
                    class="list active"
                    onClick={() =>fetchAndUpdateDisplayContent(98)} >
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"
                  ...
                  <li
                    class="list"
                    onClick={() =>fetchAndUpdateDisplayContent(99)} > 
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"

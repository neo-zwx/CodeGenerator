...
import {CDFactoryPattern,EXFactoryPattern,HTFactoryPattern} from "../../window/JavaWindow/FactoryModaljv.js"
import "../../css/pre.css";
...
const handleGenerateCode = async () => {
  try {
    const response = await fetch(`http://localhost:3002/api/templates/68`);
...
useEffect(() => {
  fetchAndUpdateDisplayContent(68); // 初始渲染時加載 templateId 為 5 的模板
            ...
            <div class="card-header">
              <div class="navigation">
                <ul>
                  <li
                    class="list active"
                    onClick={() =>fetchAndUpdateDisplayContent(68)} >
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"
                  ...
                  <li
                    class="list"
                    onClick={() =>fetchAndUpdateDisplayContent(69)} > 
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"

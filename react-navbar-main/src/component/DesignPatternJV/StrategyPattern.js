...
import { EXStrategyPattern, CDStrategyPattern, HTStrategyPattern } from "../../window/JavaWindow/StrategyModaljv.js";
import "../../css/pre.css";
import TableRow from "../TableRow.js";
//初始化表單數據
const initialFormData = {
  ConcreteStrategyA: "ConcreteStrategyA",
  ConcreteStrategyAalgorithm: "ConcreteStrategyAalgorithm",
  ConcreteStrategyB: "ConcreteStrategyB",
  ConcreteStrategyBalgorithm: "ConcreteStrategyBalgorithm",
};
...
const handleGenerateCode = async () => {
  try {
    const response = await fetch(`http://localhost:3002/api/templates/125`);
...
useEffect(() => {
  fetchAndUpdateDisplayContent(125); // 初始渲染時加載 templateId 為 5 的模板
        ...
        <div class="col-md-12">
          <div class="cardt">
            <div class="cardt-info">
              <p class="titlet">Strategy Pattern</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card-header">
              <div class="navigation">
                <ul>
                  <li
                    class="list active"
                    onClick={() =>fetchAndUpdateDisplayContent(125)} >
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"
                  ...
                  <li
                    class="list"
                    onClick={() =>fetchAndUpdateDisplayContent(126)} > 
                    <span class="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"
